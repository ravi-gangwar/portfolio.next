    ...
    features: [
      {
        ...
        description:
          "Connect with verified sustainable sellers and shop eco-conscious products",
        icon: "🌿",
      },
      {
        title: "Carbon Footprint Tracker",
        description:
          "Real-time monitoring and visualization of your environmental impact",
        icon: "📊",
      },
      {
        title: "Sustainability Education",
        description:
          "Access comprehensive resources and guides for green living",
        icon: "📚",
      },
      {
