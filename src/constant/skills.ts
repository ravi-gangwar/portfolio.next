export const skills = [
...

  {
    ...
    skills: [
      ...
      { name: "React Query", image: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" },
    ]
  },
  ...
  },
  {
    category: "os",
    skills: [
      { name: "macOS", image: "https://img.icons8.com/?size=100&id=85917&format=png&color=ffffff" },
      { name: "Linux (Ubuntu)", image: "https://upload.wikimedia.org/wikipedia/commons/9/9e/UbuntuCoF.svg" },
      { name: "Linux (Kali)", image: "https://img.icons8.com/?size=100&id=17842&format=png&color=000000" },
