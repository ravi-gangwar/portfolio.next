...
const SkillCard: React.FC<SkillCardProps> = ({ name, image }) => {
  return (
    <div className="relative w-full h-36 sm:h-40 md:h-44 lg:h-48 backdrop-blur-lg rounded-lg flex flex-col items-center justify-center p-4">
      {image && <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24">
