...
const ExperienceSection: React.FC<TExperience> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 md:p-8 text-white shadow-2xl rounded-2xl transform transition-all">
      ...
      <div className="mb-8">
        ...
        <ul className="flex flex-wrap gap-3">
          {skills.map((skill, index) => (
            <li
              key={index}
              className="bg-blue-600 text-blue-100 py-2 px-4 rounded-full text-sm font-medium hover:bg-blue-700 transition-all"
            >
              {skill}
            </li>
          ))}
